...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    mailtoLink.href = `mailto:${email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Masz pytania dotyczące naszych usług? Potrzebujesz wyceny? Napisz do nas, a my odezwiemy się najszybciej jak to możliwe.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1">Poniedziałek - Piątek: 8:00 - 18:00<br />
                      Sobota: 9:00 - 14:00</p>
                    </div>
                  </div>
                </div>
